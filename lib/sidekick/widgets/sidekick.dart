...
class _SidekickFlight {
  ...
  late Animation<double> _sidekickOpacity = kAlwaysCompleteAnimation;
  late ProxyAnimation _proxyAnimation;
  late _SidekickFlightManifest manifest;
  ...
  Widget _buildOverlay(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        ...
        if (_aborted || !toSidekickBox.attached) {
  ...
  void divert(_SidekickFlightManifest newManifest) {
    ...
    if (manifest.type == SidekickFlightDirection.toTarget &&
      ...
      if (manifest.fromSidekick != newManifest.toSidekick) {
        ...
        // TODO(hans muller): Use ReverseTween here per github.com/flutter/flutter/pull/12203.
        sidekickRectTween =
